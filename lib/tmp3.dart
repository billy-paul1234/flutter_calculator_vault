...
//   final isolate = await Isolate.spawn(isolateFunction, mainReceivePort.sendPort);

//   mainReceivePort.listen((message) {
//     print('Main isolate received: $message');
//   });

//   final sendPort = await getIsolateSendPort(isolate);

//   // Send a serializable message to the spawned isolate.
...
//   // Send a serializable message to the main isolate.
//   mainSendPort.send('Hello from the spawned isolate!');

//   // Send the isolateReceivePort's SendPort back to the main isolate.
//   mainSendPort.send(isolateReceivePort.sendPort);
// }

// Future<SendPort> getIsolateSendPort(Isolate isolate) async {
//   final receivePort = ReceivePort();
//   IsolateNameServer.registerPortWithName(receivePort.sendPort, 'isolateSendPort');

//   // Send the ReceivePort's SendPort request to the spawned isolate.
//   isolate.ping(receivePort.sendPort, response: receivePort.sendPort);
...
void main() async {
  await isolateFunction('key', 'value');
}

Future<void> isolateFunction(String key, String value) async {
  final ReceivePort receivePort = ReceivePort();

  try {
    await Isolate.spawn(copyItemsWithIsolate, receivePort.sendPort);
...
void copyItemsWithIsolate(SendPort sendPort) {
  // This function runs in a separate isolate.
  // You can perform your processing here.
  
  // Simulate some work.
  String result = 'Processed and';
